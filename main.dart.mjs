...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AO: x0 => x0.response,
      AP: x0 => x0.location,
      AQ: (x0,x1) => { x0.focusMode = x1 },
      AR: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      AS: x0 => x0.name,
      ...
      BQ: x0 => x0.focusMode,
      BR: (x0,x1,x2,x3,x4) => x0.getImageData(x1,x2,x3,x4),
      BS: (x0,x1) => x0.item(x1),
      ...
      CP: x0 => x0.metaKey,
      CQ: x0 => x0.enumerateDevices(),
      CR: (x0,x1,x2) => x0.readBarcodes(x1,x2),
      CS: x0 => x0.length,
      ...
      FQ: x0 => x0.mediaDevices,
      FR: x0 => x0.bytes,
      FS: (x0,x1) => x0.replaceChildren(x1),
      ...
      HP: x0 => x0.repeat,
      HQ: x0 => x0.mediaDevices,
      HR: x0 => x0.x,
      HS: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      IQ: () => globalThis.BarcodeDetector.getSupportedFormats(),
      IR: x0 => x0.bottomLeft,
      IS: (x0,x1) => { x0.accept = x1 },
      ...
      JP: x0 => x0.userAgent,
      JQ: (x0,x1) => x0.call(x1),
      JR: x0 => x0.bottomRight,
      JS: (x0,x1) => { x0.multiple = x1 },
      K: (exn) => {
      ...
      LO: x0 => x0.response,
      LP: (x0,x1) => x0.key(x1),
      LQ: x0 => x0.stopContinuousDecode,
      LR: x0 => x0.topLeft,
      LS: () => globalThis.removeSplashFromWeb(),
      M: o => String(o),
      ...
      NQ: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      NR: x0 => x0.isValid,
      NS: x0 => x0.getReader(),
      ...
      OQ: x0 => x0.text,
      OR: (x0,x1,x2,x3) => ({formats: x0,tryHarder: x1,tryRotate: x2,tryInvert: x3}),
      OS: x0 => x0.value,
      ...
      PP: x0 => x0.message,
      PQ: x0 => x0.barcodeFormat,
      PR: (x0,x1,x2) => ({tryHarder: x0,tryRotate: x1,tryInvert: x2}),
      PS: x0 => x0.done,
      ...
      QN: x0 => x0.src,
      QO: (x0,x1) => x0.get(x1),
      QP: (x0,x1) => ({files: x0,text: x1}),
      QQ: x0 => x0.rawBytes,
      QR: () => globalThis.ZXingWASM,
      QS: x0 => x0.read(),
      ...
      RP: x0 => ({files: x0}),
      RQ: x0 => x0.y,
      RR: (x0,x1) => { x0.height = x1 },
      RS: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      UP: (x0,x1) => { x0.transform = x1 },
      UQ: x0 => x0.message,
      UR: x0 => x0.width,
      US: () => globalThis._flutter,
      V: (constructor, args) => {
      ...
      VP: x0 => x0.style,
      VQ: x0 => x0.videoElement,
      VR: (x0,x1) => { x0.srcObject = x1 },
      W: x0 => new Array(x0),
      WB: o => {
        if (o === null || o === undefined) return 0;
      ...
      WN: x0 => x0.decode(),
      WO: x0 => x0.history,
      WP: x0 => x0.getVideoTracks(),
      WQ: x0 => x0.decodeContinuously,
      WR: x0 => ({willReadFrequently: x0}),
      X: o => [o],
      ...
      XO: x0 => x0.href,
      XP: x0 => x0.getSettings(),
      XQ: (x0,x1) => new ZXing.BrowserMultiFormatReader(x0,x1),
      XR: (x0,x1,x2) => x0.getContext(x1,x2),
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      YO: x0 => x0.location,
      YP: x0 => x0.facingMode,
      YQ: (x0,x1) => ({width: x0,height: x1}),
      YR: () => new BarcodeDetector(),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZQ: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      ZR: x0 => ({formats: x0}),
      ...
      bP: (x0,x1) => x0.append(x1),
      bQ: x0 => x0.height,
      bR: (x0,x1) => x0.detect(x1),
      c: o => o,
      ...
      dO: x0 => x0.code,
      dP: (x0,x1) => { x0.onpause = x1 },
      dQ: x0 => x0.attachStreamToVideo,
      dR: x0 => x0.format,
      e: () => globalThis,
      ...
      fP: (x0,x1) => { x0.controls = x1 },
      fQ: (x0,x1,x2) => x0.set(x1,x2),
      fR: x0 => x0.x,
      ...
      gO: x0 => x0.close(),
      gP: (x0,x1) => { x0.pointerEvents = x1 },
      gQ: (x0,x1) => x0.querySelector(x1),
      gR: x0 => x0.cornerPoints,
      ...
      hN: x0 => x0.duration,
      hO: (x0,x1) => x0.send(x1),
      hP: (x0,x1) => { x0.transformOrigin = x1 },
      ...
      jP: (x0,x1) => { x0.width = x1 },
      jQ: (x0,x1) => x0.appendChild(x1),
      ...
      kP: (x0,x1) => { x0.height = x1 },
      kQ: x0 => x0.head,
      kR: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lP: x0 => x0.getSupportedConstraints(),
      lQ: (x0,x1) => { x0.onerror = x1 },
      lR: x0 => globalThis.URL.createObjectURL(x0),
      m: () => globalThis.Math,
      ...
      nP: (x0,x1,x2) => ({width: x0,height: x1,deviceId: x2}),
      nQ: (x0,x1) => { x0.onload = x1 },
      nR: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      ...
      pP: (x0,x1) => ({width: x0,height: x1}),
      pQ: (x0,x1) => { x0.crossOrigin = x1 },
      pR: x0 => x0.height,
      ...
      qP: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      qQ: (x0,x1) => { x0.lang = x1 },
      qR: x0 => x0.width,
      r: (x0,x1) => x0.focus(x1),
      ...
      tQ: (x0,x1) => { x0.async = x1 },
      tR: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      u: () => [],
      ...
      uP: () => ({}),
      uQ: (x0,x1) => { x0.id = x1 },
      uR: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      v: (a, i) => a.push(i),
      ...
      vQ: x0 => x0.videoHeight,
      vR: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
