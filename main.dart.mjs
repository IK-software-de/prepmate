...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AQ: () => globalThis.BarcodeDetector.getSupportedFormats(),
      AR: x0 => x0.bottomLeft,
      ...
      FP: x0 => x0.message,
      FQ: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      FR: x0 => x0.isValid,
      FS: x0 => x0.value,
      ...
      GQ: x0 => x0.text,
      GR: (x0,x1,x2,x3) => ({formats: x0,tryHarder: x1,tryRotate: x2,tryInvert: x3}),
      GS: x0 => x0.done,
      ...
      HO: x0 => x0.body,
      HP: x0 => ({files: x0}),
      HQ: x0 => x0.barcodeFormat,
      HR: (x0,x1,x2) => ({tryHarder: x0,tryRotate: x1,tryInvert: x2}),
      HS: x0 => x0.read(),
      ...
      IP: x0 => ({text: x0}),
      IQ: x0 => x0.rawBytes,
      IR: () => globalThis.ZXingWASM,
      IS: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      LQ: x0 => x0.resultPoints,
      LR: x0 => x0.height,
      LS: () => globalThis._flutter,
      M: o => String(o),
      ...
      NQ: x0 => x0.videoElement,
      NR: (x0,x1) => { x0.srcObject = x1 },
      ...
      OQ: x0 => x0.decodeContinuously,
      OR: x0 => ({willReadFrequently: x0}),
      ...
      PP: x0 => x0.facingMode,
      PQ: (x0,x1) => new ZXing.BrowserMultiFormatReader(x0,x1),
      PR: (x0,x1,x2) => x0.getContext(x1,x2),
      ...
      QQ: (x0,x1) => ({width: x0,height: x1}),
      QR: () => new BarcodeDetector(),
      ...
      RQ: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      RR: x0 => ({formats: x0}),
      ...
      TO: x0 => x0.code,
      TP: (x0,x1) => x0.createElement(x1),
      TQ: x0 => x0.height,
      TR: (x0,x1) => x0.detect(x1),
      ...
      VP: (x0,x1) => { x0.onpause = x1 },
      VQ: x0 => x0.attachStreamToVideo,
      VR: x0 => x0.format,
      W: x0 => new Array(x0),
      WB: o => {
        if (o === null || o === undefined) return 0;
      ...
      XN: x0 => x0.duration,
      XO: (x0,x1) => x0.send(x1),
      XP: (x0,x1) => { x0.controls = x1 },
      XQ: (x0,x1,x2) => x0.set(x1,x2),
      XR: x0 => x0.x,
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      YN: x0 => x0.image,
      YO: x0 => x0.readyState,
      YP: (x0,x1) => { x0.pointerEvents = x1 },
      YQ: (x0,x1) => x0.querySelector(x1),
      YR: x0 => x0.cornerPoints,
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZP: (x0,x1) => { x0.transformOrigin = x1 },
      ...
      aQ: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      aR: x0 => globalThis.URL.revokeObjectURL(x0),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cO: x0 => x0.baseURI,
      cP: (x0,x1) => { x0.height = x1 },
      cQ: x0 => x0.head,
      cR: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dP: x0 => x0.getSupportedConstraints(),
      dQ: (x0,x1) => { x0.onerror = x1 },
      dR: x0 => globalThis.URL.createObjectURL(x0),
      e: () => globalThis,
      ...
      fP: (x0,x1,x2) => ({width: x0,height: x1,deviceId: x2}),
      fQ: (x0,x1) => { x0.onload = x1 },
      fR: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      ...
      iO: x0 => x0.width,
      iP: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      iQ: (x0,x1) => { x0.lang = x1 },
      iR: x0 => x0.width,
      j: x0 => x0.random(),
      ...
      lP: x0 => x0.getCapabilities(),
      lQ: (x0,x1) => { x0.async = x1 },
      ...
      nP: (x0,x1) => x0.applyConstraints(x1),
      nQ: x0 => x0.videoHeight,
      ...
      oP: (x0,x1) => { x0.whiteBalanceMode = x1 },
      oQ: x0 => x0.videoWidth,
      oR: (x0,x1) => { x0.oncancel = x1 },
      p: b => !!b,
      ...
      pP: x0 => x0.whiteBalanceMode,
      pQ: x0 => x0.stream,
      pR: (x0,x1) => { x0.onchange = x1 },
      ...
      rP: x0 => x0.exposureMode,
      rQ: x0 => x0.paused,
      rR: x0 => x0.lastModified,
      s: () => ({}),
      ...
      xQ: x0 => x0.bytes,
      xR: (x0,x1) => x0.replaceChildren(x1),
      ...
      zN: x0 => x0.send(),
      zO: x0 => x0.userAgent,
      zP: x0 => x0.mediaDevices,
      zQ: x0 => x0.x,
      zR: (x0,x1,x2) => x0.setAttribute(x1,x2),
