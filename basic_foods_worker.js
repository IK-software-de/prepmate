...
(function dartProgram() {
  ...
  var J = {
    ...
    $indexSet$x(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).$indexSet(receiver, a0, a1);
    },
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    FoodType: function FoodType(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    BasicFoodCategory_tryParse(value) {
      var _i, category;
      for (_i = 0; _i < 15; ++_i) {
        category = B.List_J9W[_i];
        if (category.jsonValue === value)
          return category;
      }
      return null;
    },
    BasicFoodCategory: function BasicFoodCategory(t0, t1, t2) {
      this.jsonValue = t0;
      this.index = t1;
      this._name = t2;
    },
    BasicFoodEntry_tryParse(json, expectedSourceId) {
      ...
      if (typeof $name != "string" || $name.length === 0)
        return _null;
      categoryValue = json.$index(0, "category");
      ...
      if (typeof source != "string" || source !== expectedSourceId)
        return _null;
      pieceWeightRaw = json.$index(0, "pieceWeightGrams");
      if (pieceWeightRaw != null) {
        if (typeof pieceWeightRaw != "number")
          return _null;
        if (pieceWeightRaw <= 0)
          return _null;
        if (unit === B.FoodType_2)
          return _null;
        pieceWeightGrams = pieceWeightRaw;
      } else
        pieceWeightGrams = _null;
      aliasesRaw = json.$index(0, "aliases");
      aliases = A._setArrayType([], type$.JSArray_String);
      if (aliasesRaw != null) {
        if (!type$.List_dynamic._is(aliasesRaw))
          return _null;
        for (t1 = aliasesRaw.length, _i = 0; _i < aliasesRaw.length; aliasesRaw.length === t1 || (0, A.throwConcurrentModificationError)(aliasesRaw), ++_i) {
          alias = aliasesRaw[_i];
          if (typeof alias != "string")
            return _null;
          B.JSArray_methods.add$1(aliases, alias);
        }
      }
      return new A.BasicFoodEntry(slug, $name, aliases, category, unit, kcal, protein, carbs, fat, pieceWeightGrams, source);
    },
    BasicFoodEntry__parseUnit(value) {
      switch (value) {
        case "g":
          return B.FoodType_0;
        case "ml":
    ...
    BasicFoodEntry__parseNutrient(value) {
      if (typeof value != "number")
        return null;
      if (value < 0)
        return null;
    ...
    BasicFoodEntry: function BasicFoodEntry(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _.slug = t0;
      _.name = t1;
      _.aliases = t2;
      ...
      _.carbs = t7;
      _.fat = t8;
      _.pieceWeightGrams = t9;
      _.source = t10;
    },
    BasicFoodsDataset_BasicFoodsDataset$parse(json) {
      var datasetVersion, sourceJson, t1, source, foodsJson, foods, seenSlugs, t2, t3, skipped, _i, entryJson, entry,
        schemaVersion = json.$index(0, "schemaVersion");
      if (!A._isInt(schemaVersion))
        throw A.wrapException(B.BasicFoodsDatasetException_JnB);
      if (schemaVersion !== 1)
        throw A.wrapException(new A.BasicFoodsDatasetException("Nicht unterst\xfctzte schemaVersion " + A.S(schemaVersion) + " (unterst\xfctzt: 1)."));
      datasetVersion = json.$index(0, "datasetVersion");
      if (!A._isInt(datasetVersion))
        throw A.wrapException(B.BasicFoodsDatasetException_xTP);
      sourceJson = json.$index(0, "source");
      t1 = type$.Map_String_dynamic;
      if (!t1._is(sourceJson))
        throw A.wrapException(B.BasicFoodsDatasetException_mbb);
      source = A.BasicFoodsSourceInfo_tryParse(sourceJson);
      if (source == null)
        throw A.wrapException(B.BasicFoodsDatasetException_SgB);
      foodsJson = json.$index(0, "foods");
      if (!type$.List_dynamic._is(foodsJson) || J.get$isEmpty$asx(foodsJson))
        throw A.wrapException(B.BasicFoodsDatasetException_4R2);
      foods = A._setArrayType([], type$.JSArray_BasicFoodEntry);
      seenSlugs = A.LinkedHashSet_LinkedHashSet$_empty(type$.String);
      for (t2 = foodsJson.length, t3 = source.id, skipped = 0, _i = 0; _i < foodsJson.length; foodsJson.length === t2 || (0, A.throwConcurrentModificationError)(foodsJson), ++_i) {
        entryJson = foodsJson[_i];
        if (!t1._is(entryJson)) {
          ++skipped;
          continue;
        }
        entry = A.BasicFoodEntry_tryParse(entryJson, t3);
        if (entry == null) {
          ++skipped;
          entryJson.toString$0(0);
          continue;
        }
        if (!seenSlugs.add$1(0, entry.slug)) {
          ++skipped;
          continue;
        }
        B.JSArray_methods.add$1(foods, entry);
      }
      return new A.BasicFoodsDataset(schemaVersion, datasetVersion, source, foods, skipped);
    },
    BasicFoodsDatasetException: function BasicFoodsDatasetException(t0) {
      this.message = t0;
    },
    BasicFoodsDataset: function BasicFoodsDataset(t0, t1, t2, t3, t4) {
      var _ = this;
      _.schemaVersion = t0;
      _.datasetVersion = t1;
      _.source = t2;
    ...
    BasicFoodsSourceInfo_tryParse(json) {
      var doi, _null = null,
        id = json.$index(0, "id"),
        title = json.$index(0, "title"),
        author = json.$index(0, "author"),
        year = json.$index(0, "year"),
        place = json.$index(0, "place"),
        version = json.$index(0, "version"),
        url = json.$index(0, "url"),
        license = json.$index(0, "license"),
        licenseUrl = json.$index(0, "licenseUrl"),
        modifications = json.$index(0, "modifications");
      ...
      if (typeof licenseUrl != "string" || licenseUrl.length === 0)
        return _null;
      if (typeof modifications != "string" || modifications.length === 0)
        return _null;
      doi = json.$index(0, "doi");
      if (doi != null && typeof doi != "string")
        return _null;
      return new A.BasicFoodsSourceInfo(id, title, author, year, place, version, A._asStringQ(doi), url, license, licenseUrl, modifications);
    },
    BasicFoodsSourceInfo: function BasicFoodsSourceInfo(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _.id = t0;
      _.title = t1;
      _.author = t2;
    ...
    encodeBasicFoodsDataset(dataset) {
      ...
      t3.$indexSet(0, "id", source.id);
      t3.$indexSet(0, "title", source.title);
      t3.$indexSet(0, "author", source.author);
      t3.$indexSet(0, "year", source.year);
      t3.$indexSet(0, "place", source.place);
      t3.$indexSet(0, "version", source.version);
      t4 = source.doi;
      if (t4 != null)
        t3.$indexSet(0, "doi", t4);
      t3.$indexSet(0, "url", source.url);
      t3.$indexSet(0, "license", source.license);
      t3.$indexSet(0, "licenseUrl", source.licenseUrl);
      t3.$indexSet(0, "modifications", source.modifications);
      t4 = A._setArrayType([], type$.JSArray_Map_of_String_and_nullable_Object);
      for (t5 = dataset.foods, t6 = t5.length, _i = 0; _i < t5.length; t5.length === t6 || (0, A.throwConcurrentModificationError)(t5), ++_i) {
        food = t5[_i];
        t7 = A.LinkedHashMap_LinkedHashMap$_empty(t1, t2);
        t7.$indexSet(0, "slug", food.slug);
        t7.$indexSet(0, "name", food.name);
        t7.$indexSet(0, "aliases", food.aliases);
        t7.$indexSet(0, "category", food.category.jsonValue);
        t7.$indexSet(0, "unit", A._unitToJson(food.unit));
        t7.$indexSet(0, "kcal", food.kcal);
        t7.$indexSet(0, "protein", food.protein);
        t7.$indexSet(0, "carbs", food.carbs);
        t7.$indexSet(0, "fat", food.fat);
        t7.$indexSet(0, "source", food.source);
        t8 = food.pieceWeightGrams;
        if (t8 != null)
          t7.$indexSet(0, "pieceWeightGrams", t8);
        t4.push(t7);
      }
      return A.LinkedHashMap_LinkedHashMap$_literal(["schemaVersion", dataset.schemaVersion, "datasetVersion", dataset.datasetVersion, "source", t3, "foods", t4, "skippedCount", dataset.skippedCount], t1, t2);
    },
    _unitToJson(unit) {
      var t1;
      switch (unit.index) {
  ...
  A.FoodType.prototype = {
    _enumToString$0() {
      return "FoodType." + this._name;
    }
  };
  A.BasicFoodCategory.prototype = {
    _enumToString$0() {
      return "BasicFoodCategory." + this._name;
    }
  };
  A.BasicFoodEntry.prototype = {};
  A.BasicFoodsDatasetException.prototype = {
    toString$0(_) {
      return "BasicFoodsDatasetException: " + this.message;
    }
  };
  A.BasicFoodsDataset.prototype = {};
  A.BasicFoodsSourceInfo.prototype = {};
  A.main_closure.prototype = {
    call$1($event) {
      var response, message, dataset, error, decoded, exception;
      A._asJSObject($event);
      response = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.nullable_Object);
      try {
        message = A.dartify($event.data);
        if (!(message instanceof A.MapBase) || typeof message.$index(0, "json") != "string")
          throw A.wrapException(B.FormatException_7DN);
        decoded = B.C_JsonCodec.decode$2$reviver(A._asString(message.$index(0, "json")), null);
        if (!type$.Map_String_dynamic._is(decoded))
          A.throwExpression(B.BasicFoodsDatasetException_g0O);
        dataset = A.BasicFoodsDataset_BasicFoodsDataset$parse(decoded);
        J.$indexSet$x(response, "ok", true);
        J.$indexSet$x(response, "dataset", A.encodeBasicFoodsDataset(dataset));
      } catch (exception) {
        error = A.unwrapException(exception);
        J.$indexSet$x(response, "ok", false);
        J.$indexSet$x(response, "error", J.toString$0$(error));
      }
      A._asJSObject(init.G.self).postMessage(A.jsify(response));
    },
    $signature: 12
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.FoodType, A.BasicFoodCategory]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "Object?(Object?)", "~(@)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "~(Object?,Object?)", "Null(JSObject)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_BasicFoodEntry: findType("JSArray<BasicFoodEntry>"),
  ...
  (function constants() {
    ...
    B.BasicFoodsDatasetException_4R2 = new A.BasicFoodsDatasetException("Wurzeldokument: foods fehlt, hat falschen Typ oder ist leer.");
    B.BasicFoodsDatasetException_JnB = new A.BasicFoodsDatasetException("Wurzeldokument: schemaVersion fehlt oder ist kein int.");
    B.BasicFoodsDatasetException_SgB = new A.BasicFoodsDatasetException("Quellenblock unvollst\xe4ndig oder ung\xfcltig.");
    B.BasicFoodsDatasetException_g0O = new A.BasicFoodsDatasetException("Wurzeldokument ist kein JSON-Objekt.");
    B.BasicFoodsDatasetException_mbb = new A.BasicFoodsDatasetException("Wurzeldokument: source fehlt oder hat falschen Typ.");
    B.BasicFoodsDatasetException_xTP = new A.BasicFoodsDatasetException("Wurzeldokument: datasetVersion fehlt oder ist kein int.");
...
;
    ...
    B.FoodType_0 = new A.FoodType(0, "grams");
    B.FoodType_1 = new A.FoodType(1, "milliliters");
    B.FoodType_2 = new A.FoodType(2, "pieces");
    B.FormatException_7DN = new A.FormatException("Worker-Anfrage ist ung\xfcltig.", null);
    B.JsonDecoder_null = new A.JsonDecoder(null);
    B.BasicFoodCategory_fruit_0_fruit = new A.BasicFoodCategory("fruit", 0, "fruit");
    B.BasicFoodCategory_vegetables_1_vegetables = new A.BasicFoodCategory("vegetables", 1, "vegetables");
    B.BasicFoodCategory_grains_2_grains = new A.BasicFoodCategory("grains", 2, "grains");
    B.BasicFoodCategory_bakery_3_bakery = new A.BasicFoodCategory("bakery", 3, "bakery");
    B.BasicFoodCategory_legumes_4_legumes = new A.BasicFoodCategory("legumes", 4, "legumes");
    B.BasicFoodCategory_QuB = new A.BasicFoodCategory("nuts-seeds", 5, "nutsSeeds");
    B.BasicFoodCategory_meat_6_meat = new A.BasicFoodCategory("meat", 6, "meat");
    B.BasicFoodCategory_qm0 = new A.BasicFoodCategory("fish-seafood", 7, "fishSeafood");
    B.BasicFoodCategory_LBu = new A.BasicFoodCategory("dairy-eggs", 8, "dairyEggs");
    B.BasicFoodCategory_rpl = new A.BasicFoodCategory("fats-oils", 9, "fatsOils");
    B.BasicFoodCategory_zNv = new A.BasicFoodCategory("herbs-spices", 10, "herbsSpices");
    B.BasicFoodCategory_sweeteners_11_sweeteners = new A.BasicFoodCategory("sweeteners", 11, "sweeteners");
    B.BasicFoodCategory_beverages_12_beverages = new A.BasicFoodCategory("beverages", 12, "beverages");
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_slugPattern", "$get$_slugPattern", () => A.RegExp_RegExp("^[a-z0-9-]+$"));
  })();
